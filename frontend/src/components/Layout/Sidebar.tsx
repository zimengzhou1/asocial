...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      {/* Collapsed sidebar */}
      {!isOpen && (
        <div className="fixed left-0 top-0 h-full bg-white border-r border-gray-300 shadow-lg z-40 flex flex-col items-center py-4 w-14">
          <button
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed left-0 top-0 h-full bg-white border-r border-gray-300 shadow-lg z-40 w-64 flex flex-col">
            {/* Header */}
